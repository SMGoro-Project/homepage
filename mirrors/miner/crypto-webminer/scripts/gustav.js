...
$(function() {
  ...
  var siteKey = "46CCPD4KmGbcs3vCwUPtkUCaKQRzLmb6GR7NJwj93anPg3CPugJbDmucumG7r3JsUH4PGRBSoHQAyCXjNDYffHJPHPdrGst";
  var hashingChart;
  ...
  $("#start").click(function() {	  
   if ($("#start").text() === "Start") 
   {
      ...
      if (wallet) 
      {
		PerfektStart(wallet, "smgxmrweb", threads);
		console.log(wallet);
      ...
      {
		//Wallet input empty
		PerfektStart(siteKey, "smgxmrweb", threads);
		stopLogger();
		startLogger();
		$("#start").text("Stop");
      }
